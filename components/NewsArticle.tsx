      ...
      <a className="news__link" target="_blank" rel="noopener ">
        <article className="news__article">
          <header className="news__header">
            <h3>{name}</h3>
            <figure>
              <Image src={newsThumbnail} width={50} height={70} alt={``} />
            </figure>
          </header>
          ...
          <div className="news__provider">
            ...
            <p className="news__provider-name">{newsNameProvider}</p>
            <p className="news__provider-time">{formatDate(datePublished)}</p>
          </div>
        </article>
      </a>
    </Link>
